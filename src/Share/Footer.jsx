...
const Footer = () => {
  return (
    <footer className="bg-[#F63E7B] p-10 tracking-wide">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="lg:flex lg:items-center">
          <a href="javascript:void(0)">
            <img src={logo} alt="logo" className="w-52 bg-white p-3 rounded-lg" />
          </a>
        </div>
      ...
      <p className='text-gray-300 text-sm mt-10'>© 2023 {new Date().getFullYear()}<a href='https://readymadeui.com/' target='_blank'
        className="hover:underline mx-1">Jerin&apos;s Parlour</a>All Rights Reserved.
      </p>
    </footer>
  );
};
